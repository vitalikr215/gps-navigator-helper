...
- [0.8.13](https://github.com/vitalikr215/gps-navigator-helper/releases/tag/0.8.13) Implemented saving and dowloading result .gpx file with added point. Fixed points name editing (now user can edit added points names).Added support of new map provider (now app could read .gpx files produced by [nakarte](https://nakarte.me) provider).
