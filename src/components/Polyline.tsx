...
function usePolyline(props: PolylineProps) {
  ...
  useMemo(() => {
    ...
    if (encodedPath && rawPath){
      console.error('Specify rawPath OR encodedPath you cant use both');
      return;
    }
    //set path from encoded path if it specified
  ...
  }, [polyline, encodedPath, rawPath, geometryLibrary]);
